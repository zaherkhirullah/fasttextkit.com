...
export const metadata = {
  ...
  description: 'ToolKit Pro terms of service. Read our terms and conditions for using our free online tools at toolzi.io.',
}
      ...
      <main>
        <div className="tool-page container">
          ...
          <div className="seo-content" style={{ maxWidth: '800px' }}>
            ...
            <p>
              By accessing or using ToolKit Pro at <strong>toolzi.io</strong>, you agree to be bound by these Terms of Service. 
            ...
            <p>
              All website design, source code, branding, and original content on toolzi.io is the intellectual property of ToolKit Pro and is protected by copyright law. 
            ...
            <ul>
              <li>Email: <a href="mailto:legal@toolzi.io" style={{color:'#8b5cf6'}}>legal@toolzi.io</a></li>
              <li>Website: <a href="https://toolzi.io" style={{color:'#8b5cf6'}}>https://toolzi.io</a></li>
            </ul>
          </div>
        </div>
      </main>

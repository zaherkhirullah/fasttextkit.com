      ...
      <main>
        <div className="tool-page container">
          ...
          <div className="seo-content" style={{ maxWidth: '800px' }}>
            ...
            <p>
              Welcome to ToolKit Pro ("we", "our", or "us"), accessible at <strong>toolzi.io</strong>. 
            ...
            <p>
              When you visit toolzi.io, we automatically collect certain information through Google Analytics and standard server logs, including:
            </p>
            <ul>
            ...
            <p>To exercise any of these rights, contact us at <a href="mailto:privacy@toolzi.io" style={{color:'#8b5cf6'}}>privacy@toolzi.io</a>.</p>
            ...
            <ul>
              <li>Email: <a href="mailto:privacy@toolzi.io" style={{color:'#8b5cf6'}}>privacy@toolzi.io</a></li>
